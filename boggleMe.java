 ...
 * \***********************************************************
 */
public class boggleMe
{
	public static void main(String[] args) throws Exception
	{
		StopWatch watch = new StopWatch();
		watch.start();
		String[][] swamp = loadBoard("input.txt");
		Solution s = new Solution(swamp);
		watch.stop();
...
class Solution
{
	...
	public Solution(String[][] x) throws IOException
	{
		board = x;
		myPath = new Stack();
		generateAlphabet();
	...
	public void generateDict() throws IOException
	{
